        ...
        <div className="footer-bottom">
          <div className="footer-bottom-content">
            ...
            <div className="footer-address">
              ...
              <a href="https://maps.app.goo.gl/cUVmFzWYrFuJQSpH8" target="_blank" rel="noopener noreferrer" className="footer-address-link">
                <p className="footer-contact-item">
                  <svg className="footer-icon" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                ...
                <p className="footer-address-continuation">Hyderabad, Telangana, India 500049</p>
              </a>
            </div>
          </div>
        </div>
