      ...
      <div className="video-main-layout">
        ...
        <main className="video-content">
          ...
          <section id="overview" className="content-section">
            ...
            <div className="capabilities-grid">
              <div className="capability-card">
                ...
                <h3 className="capability-title">SOP Document Ingestion</h3>
              ...
              <div className="capability-card">
                ...
                <h3 className="capability-title">Automatic Script Generation</h3>
                <p className="capability-description">
              ...
              <div className="capability-card">
                ...
                <h3 className="capability-title">Visual Scene Mapping</h3>
                <p className="capability-description">
              ...
              <div className="capability-card">
                ...
                <h3 className="capability-title">Voice-Over Creation</h3>
                <p className="capability-description">
              ...
              <div className="capability-card">
                ...
                <h3 className="capability-title">Animated Training Videos</h3>
                <p className="capability-description">
              ...
              <div className="capability-card">
                ...
                <h3 className="capability-title">Compliance-Friendly Outputs</h3>
                <p className="capability-description">
              ...
              <div className="capability-card">
                ...
                <h3 className="capability-title">Multi-Format Delivery</h3>
                <p className="capability-description">
                  Export videos in multiple formats (MP4, WebM, MOV) with customizable resolutions 
                  and quality settings for different platforms.
                </p>
              </div>
            </div>
          </section>
          ...
          <section id="workflow" className="content-section">
            <h2 className="section-title">SOP-to-Video Workflow</h2>
            <div className="workflow-steps">
              ...
              <div className="workflow-step">
                ...
                <div className="step-content">
                  <h3 className="step-title">AI Analysis & Script Generation</h3>
                  <p className="step-description">
              ...
              <div className="workflow-step">
                ...
                <div className="step-content">
                  <h3 className="step-title">Visual Scene Mapping</h3>
                  <p className="step-description">
              ...
              <div className="workflow-step">
                ...
                <div className="step-content">
                  <h3 className="step-title">Video Production</h3>
                  <p className="step-description">
          ...
          <section id="use-cases" className="content-section">
            ...
            <div className="use-cases-grid">
              <div className="use-case-card">
                ...
                <h3 className="use-case-title">GMP Training</h3>
              ...
              <div className="use-case-card">
                ...
                <h3 className="use-case-title">Employee Onboarding</h3>
                <p className="use-case-description">
              ...
              <div className="use-case-card">
                ...
                <h3 className="use-case-title">Compliance Training</h3>
                <p className="use-case-description">
          ...
          <section className="content-section">
            ...
            <div className="stats-grid">
              <div className="stat-card">
                ...
                <div className="stat-label">Reduction in Production Time</div>
              </div>
              <div className="stat-card">
              ...
              <div className="stat-card">
                ...
                <div className="stat-label">Automated Processing</div>
              </div>
            </div>
          </section>
